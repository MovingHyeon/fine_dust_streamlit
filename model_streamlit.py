...
with mapbox:
    ...
    st.components.v1.html(map._repr_html_(), width=520, height=320)
...
with metricbox:
    ...
    with metric3:
        ...
        fig3.update_layout(width = 200, height=150, margin_b = 0, margin_t = 45, margin_r = 20)
    ...
    with metric4:
        ...
        fig4.update_layout(width = 200, height=150, margin_b = 0, margin_t = 45, margin_r = 20)
    ...
    st.markdown("**:violet[PC3]**: 대중교통 이용률, 생활폐기물 및 지정폐기물 배출량 관련 지표")
